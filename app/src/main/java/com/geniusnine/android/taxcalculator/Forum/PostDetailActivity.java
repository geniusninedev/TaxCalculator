package com.geniusnine.android.taxcalculator.Forum;
...
public class PostDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        // Initialize Database
        mPostReference = FirebaseDatabase.getInstance().getReference().child(getString(R.string.app_id)).child("Forum").child("posts").child(mPostKey);
        mCommentsReference = FirebaseDatabase.getInstance().getReference().child(getString(R.string.app_id)).child("Forum").child("post-comments").child(mPostKey);
